...
describe('v1.CloudDeployClient', () => {
    ...
    describe('getDeliveryPipeline', () => {
        it('invokes getDeliveryPipeline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetDeliveryPipelineRequest', ['name']);
    ...
    describe('getTarget', () => {
        it('invokes getTarget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTargetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRelease', () => {
        it('invokes getRelease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetReleaseRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('approveRollout', () => {
        it('invokes approveRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ApproveRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('getRollout', () => {
        it('invokes getRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetRolloutRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('createDeliveryPipeline', () => {
        it('invokes createDeliveryPipeline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateDeliveryPipelineRequest', ['parent']);
    ...
    describe('updateDeliveryPipeline', () => {
        it('invokes updateDeliveryPipeline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateDeliveryPipelineRequest', ['deliveryPipeline', 'name']);
    ...
    describe('deleteDeliveryPipeline', () => {
        it('invokes deleteDeliveryPipeline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteDeliveryPipelineRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createTarget', () => {
        it('invokes createTarget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateTargetRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('updateTarget', () => {
        it('invokes updateTarget without error', async () => {
            ...
            request.target ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateTargetRequest', ['target', 'name']);
    ...
    describe('deleteTarget', () => {
        it('invokes deleteTarget without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTargetRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRelease', () => {
        it('invokes createRelease without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateReleaseRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('createRollout', () => {
        it('invokes createRollout without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateRolloutRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.longrunning.Operation()
    ...
    describe('listDeliveryPipelines', () => {
        it('invokes listDeliveryPipelines without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListDeliveryPipelinesRequest', ['parent']);
            request.parent = defaultValue1;
    ...
    describe('listTargets', () => {
        it('invokes listTargets without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTargetsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listReleases', () => {
        it('invokes listReleases without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListReleasesRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
    ...
    describe('listRollouts', () => {
        it('invokes listRollouts without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListRolloutsRequest', ['parent']);
            request.parent = defaultValue1;
            const expectedHeaderRequestParams = `parent=${defaultValue1}`;const expectedResponse = [
